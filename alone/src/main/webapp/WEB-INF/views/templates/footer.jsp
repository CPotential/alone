	...
	<div class="footer_top hidden-xs">
		<div class="container">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-3">
					<div class="footer__item">
						...
						<div class="footer__content">
							<p>안녕?</p>
							<p>
								혼자 놀고 싶은사람만,<br> Consectetur adipiscing elit
							</p>
							<p>
								Phone: +0 000 000 00 00<br> Fax: +0 000 000 00 00
							</p>
							<p>
				...
				<div class="col-xs-12 col-sm-3">
					<div class="footer__item">
						<div class="footer__title">제휴 사이트</div>
						<div class="footer__content">
							<ul class="footer__links">
								<li><a href="#">Trip talk Korea</a></li>
								<li><a href="#">N 빵</a></li>
							</ul>
						</div>
					</div>
