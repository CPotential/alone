		...
		<div class="col-sm-8 col-md-9 col-lg-10">
			...
			<form method="post" role="form" action="${pageContext.request.contextPath}/introduceWrite.do" id="form_introduceWrite">
				...
				<div class="form-group">
					...
					<input type="text" name="companyName" class="form-control" placeholder="company_name"  data-original-title="" title=""> 
					<span class="help-block"></span>
				</div>
				<div class="form-group">
					<label for="region">키워드</label> 
					<input type="text" name="keyword" class="form-control" placeholder="keyword" data-original-title="" title=""> 
					<span class="help-block"></span>
				</div>
				<div class="form-group">
					<label for="location">지역</label> 
					<input type="text" name="region" class="form-control" placeholder="region" data-original-title="" title=""> 
					<span class="help-block"></span>
				</div>
				<div class="form-group">
					<label for="interest">상세주소</label> 
					<input type="text" name="location" class="form-control" placeholder="location" data-original-title="" title=""> 
					<span class="help-block"></span>
				</div>
				<div class="form-group">
					<label for="interest">영업시간</label> 
					<input type="text" name="businessHours" class="form-control" placeholder="business_hours" data-original-title="" title=""> 
					<span class="help-block"></span>
				</div>
				<div class="form-group">
					<label for="interest">전화번호</label> 
					<input type="text" name="tel" class="form-control" placeholder="tel" data-original-title="" title=""> 
					<span class="help-block"></span>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" name="mainImage" class="form-control" placeholder="mainImage" data-original-title="" title=""> 
					<button type="button" class="btn btn-xs btn-primary">선택</button>
					<span class="help-block"></span>
				</div>
				<div class="form-group">
					<label for="interest">사진첨부</label> 
					<input type="text" name="Image" class="form-control" placeholder="Image" data-original-title="" title=""> 
					<button type="button" class="btn btn-xs btn-primary">선택</button>
					<span class="help-block"></span>
				</div>
					...
					<div id="recaptcha_widget" style="display: none">
						<div class="row">
							<div class="col-xs-12 col-md-12">
								...
								<!-- reCAPTCHA input -->
								<input class="form-control input-sm" type="text" id="recaptcha_response_field" name="recaptcha_response_field" />
							</div>
						</div>
					</div>
					<!-- / #recaptcha_widget -->
