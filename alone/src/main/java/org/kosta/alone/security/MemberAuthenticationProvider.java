package org.kosta.alone.security;
...
public class MemberAuthenticationProvider implements AuthenticationProvider {
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		 ...
		 * 		//패스워드가 틀리면 throw new BadCredentialsException("패스워드가 틀립니다."); 
		 * }
		 */
		...
		} else if(list.get(0).getAuthority().equals("ROLE_COMPANY_NON_VERIFIED")){
			throw new UsernameNotFoundException("미승인 회원입니다.");
		}
